...
javac -cp $CLASSPATH src/*.java src/test/java/*.java src/lib/error/*.java src/lib/ir/*.java src/lib/ir/ast/*.java src/lib/ir/semcheck/*.java src/lib/ir/interpreter/*.java src/lib/ir/icode/*.java -d classes/
